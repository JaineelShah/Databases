...
$BODY$;
CALL sample_insert(1, 101, 'asad', '2020-08-22');
CALL sample_insert(2, 102, 'bsdad', '2020-08-22');
...
as $$
begin
create table checktb(i int);
commit;
insert into checktb values(9);
commit;
delete from checktb;
rollback;
end $$
